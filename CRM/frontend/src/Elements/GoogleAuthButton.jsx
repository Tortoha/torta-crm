...
function GoogleAuthButton() {
  ...
  useEffect(() => {
    ...
    if (err === 'google_cancelled') setError(t('auth.google.cancelled'));
    else if (err) setError(t('auth.google.failed'));
  }, [searchParams, t]);
  ...
  return (
    <div className="oauth-wrap">
      <div className="oauth-divider"><span>{t('auth.common.or')}</span></div>
      <button
        type="button"
        className="oauth-btn"
        onClick={handleClick}
